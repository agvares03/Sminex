//
//  NewRegistration_Sminex_SMS.swift
//  Sminex
//
...
final class NewRegistration_Sminex_SMS: UIViewController, UIGestureRecognizerDelegate, UITextFieldDelegate {
